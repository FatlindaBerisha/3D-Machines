...
import { HiPrinter, HiScissors, HiPhone, HiPencilSquare, HiTrash } from "react-icons/hi2";
                    ...
                    <div className="details-left-header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', borderBottom: '1px solid #e2e8f0', paddingBottom: '15px', marginBottom: '15px' }}>
                        <div style={{ flex: 1 }}>
                            ...
                            <p style={{ margin: '5px 0 0 0', fontSize: '13px', color: '#64748b' }}>
                                {job.material?.name || t('common.noMaterial')} • {t('task.createdOn')} {new Date(job.createdAt).toLocaleDateString()}
                            </p>
                        </div>
                    ...
                    <div className="chat-header">
                        ...
                        <div style={{ display: 'flex', gap: '10px', alignItems: 'center' }}>
                            ...
                            {isChatSearchOpen ? (
                                ...
                                <div
                                    style={{ width: '36px', height: '36px', borderRadius: '10px', background: 'rgba(255, 255, 255, 0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer' }}
